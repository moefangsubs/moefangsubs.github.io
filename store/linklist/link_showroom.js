...
"01" : "This category only for 'Fansub Partner'. Fansub Partner is a collaborative post with MoeFang Subs, which includes the restrictions applied to MoeFang Subs (prohibition of reupload, removal or/and add credits without permission). However, any errors in translation or otherwise are the responsibility of the fansub owner. Our release this time from our fansub partner \"MochiWorld\" is Ikeda Teresa's first SHOWROOM.",
"02" : "This category only for 'Fansub Partner'. Fansub Partner is a collaborative post with MoeFang Subs, which includes the restrictions applied to MoeFang Subs (prohibition of reupload, removal or/and add credits without permission). However, any errors in translation or otherwise are the responsibility of the fansub owner. Our release this time from our fansub partner \"MochiWorld\" is Ogawa Aya's first SHOWROOM.",
"03" : "This category only for 'Fansub Partner'. Fansub Partner is a collaborative post with MoeFang Subs, which includes the restrictions applied to MoeFang Subs (prohibition of reupload, removal or/and add credits without permission). However, any errors in translation or otherwise are the responsibility of the fansub owner. Our release this time from our fansub partner \"MochiWorld\" is Okuda Iroha's first SHOWROOM.",
...
const descEpisode = {
	"01" : "| 230302 NOGIOBI (Ikeda Teresa)",
	"02" : "| 230303 NOGIOBI (Ogawa Aya)",
	"03" : "| 230307 NOGIOBI (Okuda Iroha)",
