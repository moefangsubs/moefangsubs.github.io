document.addEventListener("DOMContentLoaded", async function() {
    // Base URL untuk gambar penlight
    const penlightBaseUrl = "https://ik.imagekit.io/moearchive/penlight";

    // Peta kode warna -> nama file gambar
    const penlightMap = {
    ...
    // Peta kode warna -> nama yang bisa dibaca manusia
    const colorNameMap = {
    ...
    try {
        ...
        document.querySelectorAll(".penlist").forEach(container => {
            ...
            for (const gen in groupPenlightData) {
                // Menggunakan 'gen' asli (e.g., 'kyog', 'sakog') untuk data attribute
    ...
    function renderMember(container, memberPenlight, memberDetails, group, gen) {
        ...
        wrapper.setAttribute('data-gen', gen); // Simpan data generasi asli
    ...
    function setupFilters(penlightData) {
        ...
        // --- [BARU] Data generasi yang tersedia untuk setiap grup ---
        ...
        // Menambahkan Keyakizaka sebagai entitas terpisah untuk filter generasi
        groupGenAvailability.keyakizaka46 = ['grad'];

        // --- [BARU] Fungsi untuk memperbarui tombol generasi ---
        ...
        groupButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                // Reset filter gen dan perbarui tombol
                currentGen = 'all';
        ...
        function applyFilters() {
            ...
            allMembers.forEach(member => {
                ...
                const memberGen = member.dataset.gen; // gen asli: noog, kyog, sakog
                const simplifiedGen = memberGen.endsWith('og') ? 'grad' : memberGen; // gen sederhana: grad, gen3

                // --- [REVISI] Logika pencocokan grup dan generasi ---
            ...
            // Menyembunyikan judul jika tidak ada member yang ditampilkan
        ...
        // Inisialisasi tombol generasi saat pertama kali load
