document.addEventListener('DOMContentLoaded', () => {
	...
	const adjustRowScaling = (row) => {
		...
		let baseScale = 1.6;  
		if (viewportWidth <= 1400) baseScale = 1.3;  
		if (viewportWidth < 1024) baseScale = 1.1;  
		const baseGap = 40;
		const gapStep = 5;
