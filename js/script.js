// --------------------------------------
// Fungsi mendeteksi karakter Jepang (kanji, hiragana, katakana)
// --------------------------------------
...
// --------------------------------------
// Fungsi list kiri kanan panah (Hanya Versi Perbaikan)
// --------------------------------------
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Hanya jalankan kode jika semua elemen yang dibutuhkan ada di halaman
    if (container && leftBtn && rightBtn) {
        ...
        function calculateItemWidth() {
            ...
            if (!acaraItem) return 0; // Pengaman jika .acara tidak ada
