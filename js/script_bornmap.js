document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        // Consolidate member data into a structured object
        const allMembers = {
    ...
    // ==========================================================
    // === FUNGSI BARU UNTUK FORMAT NAMA ===
    // ==========================================================
    /**
     * Mengubah string menjadi format Title Case.
     * Contoh: "IWAMOTO Renka" -> "Iwamoto Renka"
    ...
    function setupMap(prefectures, members) {
        ...
        // 1. Create member content containers
        ...
        // 2. Populate member cards and count members per prefecture
        const prefCount = {};
        Object.entries(members).forEach(([category, memberList]) => {
            memberList.forEach(member => {
                ...
                if (targetDiv) {
                    ...
                    // ==========================================================
                    // === PERUBAHAN DISINI: MENGGUNAKAN toTitleCase() ===
                    // ==========================================================
                    memberDiv.innerHTML = `
        ...
        // 3. Color map based on member count
