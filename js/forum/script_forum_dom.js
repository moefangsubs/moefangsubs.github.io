...
/**
 * Injeksi kerangka HTML utama ke #forum-root
 */
export function injectHTML() {
    ...
    // --- (INI DARI PERBAIKAN TOMBOL TOGGLE) ---
    // Tombol toggle diletakkan di luar #forum-root 
    const toggleBtnHTML = `
...
/**
 * Mengambil semua elemen DOM yang sering digunakan
