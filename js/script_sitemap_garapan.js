...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (garapanContainer) {
        ...
        const categoryDetails = {
            "01_variety": { name: "TV VARIETY SHOWS", path: '../store/subs/01_variety' },
            "02_nogidouga": { name: "NOGI DOUGA CONTENTS", path: '../store/subs/02_nogidouga' },
            "03_web": { name: "WEB CONTENTS", path: '../store/subs/03_web' },
            ...
            "06_drama": { name: "DRAMAS", path: '../store/subs/06_drama' },
            "07_movie": { name: "MOVIES", path: '../store/subs/07_movie' },
            "08_documentary": { name: "DOCUMENTARIES", path: '../store/subs/08_documentary' },
            "09_sapporo": { name: "CUPSTAR SERIES", path: '../store/subs/09_sapporo' },
            "10_musicprogram": { name: "MUSIC PROGRAM PERFORMANCES", path: '../store/subs/10_musicprogram' },
            "11_random": { name: "RANDOM CONTENT", path: '../store/subs/11_random' },
            "12_concert": { name: "CONCERT & LIVE PERFORMANCES", path: '../store/subs/12_concert' },
            "13_premium": { name: "PREMIUM CONTENT", path: '../store/subs/13_premium' },
            "14_radio": { name: "RADIO & READING", path: '../store/subs/14_radio' },
            "15_nonsakamichi": { name: "NON-SAKAMICHI CONTENT", path: '../store/subs/15_nonsakamichi' }
        };
